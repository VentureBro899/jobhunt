<template>
  <div>
    ...
    <van-form validate-trigger="onChange" @submit="onSubmit">
      ...
      <van-field v-model="detail" rows="8" autosize label="详情" type="textarea" show-word-limit maxlength="4000" placeholder="请输入详情" :rules="[{required,message:'详情不能为空，且在10到4000字之间',pattern: /^[\u4e00-\u9fa5\w\W\d\D\r\t\n\s]{10,4000}$/}]" />
      <div class="uploader">
